    ...
    describe('Page Tests', function() {
        ...
        describe('render function', function() {
            it('renders all sub components with expected data', function() {
                ...
                //above.
                var controlInstance = ReactTestUtils.findRenderedDOMComponentWithClass(pageInstance, 'mock-controls'),
                    listInstance  = ReactTestUtils.findRenderedDOMComponentWithClass(pageInstance, 'mock-list'),
                    mapInstance  = ReactTestUtils.findRenderedDOMComponentWithClass(pageInstance, 'mock-state-map');
